...
#
# Before submitting Lab 9, run this script and make sure all test cases pass!
...
# DSC 259 preferred styles
pio.templates["dsc259"] = go.layout.Template(
    layout=dict(
...
pio.templates.default = "simple_white+dsc259"
